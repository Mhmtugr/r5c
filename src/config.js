...
const appConfig = {
  ...
  ai: {
    ...
    openRouter: {
      ...
      defaultModels: {
        chat: env.VITE_OPENROUTER_CHAT_MODEL || 'google/gemini-2.5-pro-exp-03-25', // Model adı güncellendi
        instruct: env.VITE_OPENROUTER_INSTRUCT_MODEL || 'google/gemini-flash-1.5',
        technical: env.VITE_OPENROUTER_TECHNICAL_MODEL || 'google/gemini-2.5-pro-exp-03-25', // Model adı güncellendi
      },
      siteUrl: env.VITE_SITE_URL || 'https://erp.mehmet-endustriyel.com', // config.js'den alınacak
      appName: 'METS AI Assistant', // config.js'den alınacak
